...
#     )
# add_bg_from_local('image/w_bg.jpg')
...
def main():
    ...
    Template_2=''' Agreement No. 8767-19-IT
0 | P a g e
Table of Contents
...
11 | P a g e '''
    ...
    st.title("Please Provide Content to Replace ")

    # Create a dictionary to store input values
    input_values = {
        "Proposal Type": None,
        "Proposal Requestor First Name": None,
        "Proposal Requestor Last Name": None,
        "Proposal Requestor Email Address": None,
        "Proposal Requestor Email Address": None,
        "Client Name Last Name": None,
        "Client Name Last Name": None,
        "Client Name Email Address": None,
        "Client Procurement/RFP Contact First Name": None,
        "Client Procurement/RFP Contact Last Name": None,
        "Client Procurement/RFP Contact Email Address": None,
        "Proposal_Due_data": None,
        "Proposal_Exp_date": None,
        # "Input 16": None,
        # "Input 13": None,
        # "Input 14": None,
        # "Input 15": None
    ...
    # Row 1
    st.write("Proposal")
    input_values["Type"] = st.selectbox(
        'Proposal Type',
        ('New', 'Maintenance'))

    st.write("Proposal Requestor") 
    col1, col2, col3,  = st.columns(3)
    input_values["Proposal Requestor First Name"] = col1.text_input("First Name")
    input_values["Proposal Requestor Last Name"] = col2.text_input("Last Name")
    input_values["Proposal Requestor Email Address"] = col3.text_input("Email Address")
    # input_values["Client Procurement/RFP Contact"] = col4.text_input("Client Procurement/RFP Contact:")

    # Row 2
    st.write("Client Name") 
    col5, col6, col7 = st.columns(3)
    input_values["Client Name"] = col5.text_input("Client Name ")
    input_values["Client Short Name"] = col6.text_input("Client Short Name ")
    input_values["Client Name Email Address"] = col7.text_input("Email Address ")

    # Row 3
    st.write("Client Procurement/RFP Contact") 
    col9, col10 , col11 = st.columns(3)
    input_values["Client Procurement/RFP Contact First Name"] = col9.text_input("First Name  ")
    input_values["Client Procurement/RFP Contact Last Name"] = col10.text_input("Last Name  ")
    input_values["Client Procurement/RFP Contact Email Address"] = col11.text_input("Email Address  ")

    # Row 3
    st.write("Proposal") 
    col13, col14  = st.columns(2)
    input_values["Proposal_Due_data"] = col13.text_input("Due Date")
    input_values["Proposal_Exp_date"] = col14.text_input("Expiry Date")
    # input_values["Email Address"] = col11.text_input(÷"Email Address")
    ...
    # if (input_values["Client Name First Name"]==None and input_values["Client Name Last Name"]!=None):
    #     converted_=converted_.replace("City of Oxnard"," "+input_values["Client Name Last Name"])
    #     # st.write(converted_)


    # if (input_values["Client Name First Name"]!=None and input_values["Client Name Last Name"]!=None):
    #     converted_=converted_.replace(" City"," "+input_values["Client Name First Name"]+" "+input_values["Client Name Last Name"])
    #     # st.write(converted_)

    
    # if (input_values["Client Name First Name"]!=None and input_values["Client Name Last Name"]==None):
    #     converted_=converted_.replace(" City"," "+input_values["Client Name First Name"])
    #     # st.write(converted_)
